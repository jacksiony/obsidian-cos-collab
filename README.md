...
这是一套基于文章《用 OpenClaw + Obsidian + COS 搭一个「可控 AI 知识系统」》整理的完整技能包。它解决了 AI 直接操作 Obsidian 带来的风险：乱改文件、无版本控制、多端同步冲突。
...
本文基于 [参数之缘](https://mp.weixin.qq.com/s/Rs_ioKdbTbZcFuATM9Mmtw) 的两篇文章整理：
- 《用 OpenClaw + Obsidian + COS 搭一个「可控 AI 知识系统」》
- 《OpenClaw 在腾讯云，我的 Obsidian 在本地：我是怎么让它们安全协作的》
